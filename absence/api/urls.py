...
from absence.api.views import get_all_promotions, liste_etudiant_dans_promotion, absence_etudiant_connecte, \
    ...
    list_etudiant_seance, list_etudiant_absent_seance, absence_modifier, list_matiere, seance_matiere
...
urlpatterns = [
    ...
    path('seance/matiere/<int:id>', seance_matiere, name="seanceMatiereApi"),
]